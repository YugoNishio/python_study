...
class Earth:
    ...
    @property
    def year(self): #プロパティ名を[year]とする
        pass #特にこの関数で実行する内容無し
    @year.getter
    def year(self): #メソッドを通して属性値を取得
        return self.__year #yearメソッドがインスタンス変数の値を持つことになる
...
earth.year = '16世紀' もちろんこの表記で書き換えは出来ない
earth._Earth__year = '17世紀' なおこの表記は直接インスタンス変数を参照しているため書き換えられる
"""
